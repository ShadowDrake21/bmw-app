...
const DesignFirstScreen = (item: IDesignFirstScreen) => {
  ...
  return (
    <div className="xl:relative">
      ...
      <div className="video__shadow relative bg-black text-white pt-[25px] pb-[60px] xl:absolute xl:bg-transparent xl:z-40 xl:before:hidden xl:bottom-[50px] xl:pt-0">
        <div className="mx-[8%] sm:flex sm:gap-10">
