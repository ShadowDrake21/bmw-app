...
const MakeItYours = (object: IMakeItYours) => {
  ...
  const linkTextCommonStyles =
    'text-13 leading-4 font-bold tracking-0.5 capitalize xl:text-15 xl:leading-5'
  ...
  return (
    <section id="make-it-yours">
      <div className="sm:flex sm:flex-row-reverse relative">
        <div className="pt-60 pb-10 sm:w-1/2 xl:w-2/5 xl:py-80">
          <div
            className={`${
              isInViewport
          ...
          >
            <div className="mx-normalProcents text-[#221f1f]">
              <h2 className="text-11 leading-[13px] tracking-2.75 font-bold mb-[10px] xl:text-xs">
                {type}
              </h2>
              <h3 className="text-2xl tracking-minusSX sm:text-[30px] sm:leading-[38px] xl:text-[39px] xl:leading-[48px]">
                {title}
              </h3>
              <div className="py-[30px] relative after:absolute after:w-full after:h-[1px] after:bg-[#CACACA] after:bottom-0 after:left-0">
                ...
                <p className="mt-[5px] text-xs tracking-0.25 sm:text-13 sm:leading-4">
                  {leaseOfferInfo.description}
                </p>
                <a
                  href={leaseOfferInfo.importantInfoLink}
                  className="inline-block text-11 leading-[13px] font-bold capitalize tracking-0.25 mt-5 border-b border-[#221f1f]"
                >
                  important info
                </a>
              </div>
              <div className="py-5">
                ...
                >
                  <span className="capitalize text-xs tracking-0.25 font-bold sm:text-13 sm:leading-4">
