...
const Ownership = (props: Props) => {
  return (
    <div className="pt-10 pb-12 sm:py-[60px] xl:py-[80px]">
      ...
      <div className="mx-[8%] sm:pt-[25px] xl:mx-[4%]">
        <div className="mb-11 grid grid-cols-[auto_auto] gap-x-[4%] gap-y-[40px] sm:gap-y-[60px] sm:gap-x-[12%] xl:grid-cols-[auto_auto_auto_auto] xl:mb-[20px] xl:gap-x-[4%]">
