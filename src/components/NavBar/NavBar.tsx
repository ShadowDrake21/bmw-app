...
const NavBar = (props: Props) => {
  ...
  const toggleOverflow = (initialBoolValue: boolean) => {
    const newOverflowValue = !initialBoolValue ? 'hidden' : 'auto'
    document.documentElement.style.overflowY = newOverflowValue
  }
  ...
  return (
    <div className="absolute z-30 w-full">
      <nav className="relative">
        <div
          className={`${
            menuIsToggled ? 'bg-white text-[#666]' : ' text-white '
          } h-[70px] xl:h-[85px]  px-6 sm:px-[4%]`}
        >
          <div className="flex justify-between h-full xl:border-b xl:border-b-white">
            ...
            <div className="flex items-center justify-center">
              ...
              <button
                ...
                onClick={() => {
                  setMenuIsToggled(toggleExpression(menuIsToggled))
                  toggleOverflow(menuIsToggled)
                }}
              >
                {menuIsToggled ? (
