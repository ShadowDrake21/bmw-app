    ...
    <div ref={ref}>
      ...
      >
        ...
        <div className="text-center sm:pt-3">
          <h5 className="text-base leading-[20px] text-[#77787b] font-normal mb-[5px] sm:text-lg sm:leading-[22px] sm:tracking-minusSX xl:text-xl xl:leading-6">
            {title}
          </h5>
          <a
            href={link}
          ...
          >
            <span className="text-[#221f1f] text-xs font-bold tracking-0.25 capitalize transition-all duration-150 hover:text-[#1d55a2] sm:text-15 sm:leading-[18px] xl:text-base xl:leading-5">
              Start Designing
            </span>
          </a>
        </div>
