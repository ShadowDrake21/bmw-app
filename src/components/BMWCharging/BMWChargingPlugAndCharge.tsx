    ...
    <div className="bg-[#f6f6f6] px-[5%] py-10">
      <div className="w-full sm:flex sm:gap-[8%] sm:items-center">
        ...
        <div className="w-full">
          <h4 className="text-[14px] leading-[17px] font-bold tracking-0.25 mb-[10px] sm:text-15 sm:leading-6 xl:text-base xl:leading-[26px]">
            Plug and Charge
          </h4>
          <p className="text-xs leading-[18px] font-normal gap-4 tracking-0.5 sm:text-13 sm:leading-5">
